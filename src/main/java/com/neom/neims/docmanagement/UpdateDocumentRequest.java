...
/**
 * Actually not all parameters goes here. Only those that are later saved as document properties in Alfresco.
 * This is enforced by a way how the mapper works.
 */
@Data
